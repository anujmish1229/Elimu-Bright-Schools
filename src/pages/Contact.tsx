          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                <a href="mailto:elimubrightschools@gmail.com" className="flex items-start gap-4 group">
                ...
                >
                  ...
                  {error && (
                    <p className="text-sm text-destructive font-body">
                      Something went wrong. Please email us directly at elimubrightschools@gmail.com.
                    </p>
                  )}
